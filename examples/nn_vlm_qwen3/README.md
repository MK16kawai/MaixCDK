VLM Qwen3-VL Project based on MaixCDK
====

Run LLM Qwen3-VL eample.
...
Models:
* Qwen3-VL-maixcam2: https://huggingface.co/sipeed/Qwen3-VL-maixcam2

**Attention**: Run VLM will cost a lot of memory, please make sure you have enough memory to run it.
For example, on MaixCAM2, Qwen3-VL need 2GB memory.
...
Here we can see `cmm_total` is `2GB`, so we can run Qwen3-VL model.
